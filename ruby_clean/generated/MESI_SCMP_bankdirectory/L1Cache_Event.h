...
enum L1Cache_Event {
  ...
  L1Cache_Event_TLoad,  /**< Transactional load request from the home processor */
  L1Cache_Event_Ifetch,  /**< I-fetch request from the home processor */
  L1Cache_Event_Store,  /**< Store request from the home processor */
  L1Cache_Event_TStore,  /**< Transactional store request from home processor */
  ...
  L1Cache_Event_Fwd_TGETS,  /**< TGETS from other processor */
  L1Cache_Event_Fwd_TGETX,  /**< TGETX from other processor */
  ...
  L1Cache_Event_Data_all_Acks_Threat,  /**< Data from another processor was threatened. Can't trust the data. Need L2 to send. */
  L1Cache_Event_Ack,  /**< Ack for processor */
  L1Cache_Event_Ack_all,  /**< Last ack for processor */
  L1Cache_Event_Ack_all_Threat,  /**< Last ack for processor */
