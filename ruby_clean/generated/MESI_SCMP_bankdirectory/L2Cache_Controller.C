...
L2Cache_Controller::L2Cache_Controller(Chip* chip_ptr, int version)
{
  ...
  s_profiler.possibleTransition(L2Cache_State_TMT_B, L2Cache_Event_L1_PUTX);
  s_profiler.possibleTransition(L2Cache_State_TMT_B_MT, L2Cache_Event_L1_PUTX);
  ...
  s_profiler.possibleTransition(L2Cache_State_TMT_B, L2Cache_Event_L1_PUTX_old);
  s_profiler.possibleTransition(L2Cache_State_TMT_B_MT, L2Cache_Event_L1_PUTX_old);
  ...
  s_profiler.possibleTransition(L2Cache_State_TMT_B, L2Cache_Event_L2_Replacement);
  s_profiler.possibleTransition(L2Cache_State_TMT_B, L2Cache_Event_L2_Replacement_clean);
  s_profiler.possibleTransition(L2Cache_State_TMT_B_MT, L2Cache_Event_L2_Replacement);
  s_profiler.possibleTransition(L2Cache_State_TMT_B_MT, L2Cache_Event_L2_Replacement_clean);
  s_profiler.possibleTransition(L2Cache_State_SS_MB, L2Cache_Event_L1_GETS);
  s_profiler.possibleTransition(L2Cache_State_SS_MB, L2Cache_Event_L1_TGETS);
  s_profiler.possibleTransition(L2Cache_State_SS_MB, L2Cache_Event_L1_TGETX);
  ...
  s_profiler.possibleTransition(L2Cache_State_MT_MB, L2Cache_Event_L1_TGETS);
  s_profiler.possibleTransition(L2Cache_State_MT_MB, L2Cache_Event_L1_TGETX);
  ...
  s_profiler.possibleTransition(L2Cache_State_MT_IIB, L2Cache_Event_L1_TGETS);
  s_profiler.possibleTransition(L2Cache_State_MT_IIB, L2Cache_Event_L1_TGETX);
  ...
  s_profiler.possibleTransition(L2Cache_State_TMT_B, L2Cache_Event_L1_GETS);
  s_profiler.possibleTransition(L2Cache_State_TMT_B, L2Cache_Event_L1_TGETS);
  s_profiler.possibleTransition(L2Cache_State_TMT_B, L2Cache_Event_L1_TGETX);
  s_profiler.possibleTransition(L2Cache_State_TMT_B, L2Cache_Event_L1_GET_INSTR);
  s_profiler.possibleTransition(L2Cache_State_TMT_B, L2Cache_Event_L1_GETX);
  s_profiler.possibleTransition(L2Cache_State_TMT_B, L2Cache_Event_L1_UPGRADE);
  s_profiler.possibleTransition(L2Cache_State_TMT_B_MT, L2Cache_Event_L1_GETS);
  s_profiler.possibleTransition(L2Cache_State_TMT_B_MT, L2Cache_Event_L1_TGETS);
  s_profiler.possibleTransition(L2Cache_State_TMT_B_MT, L2Cache_Event_L1_TGETX);
  s_profiler.possibleTransition(L2Cache_State_TMT_B_MT, L2Cache_Event_L1_GET_INSTR);
  s_profiler.possibleTransition(L2Cache_State_TMT_B_MT, L2Cache_Event_L1_GETX);
  s_profiler.possibleTransition(L2Cache_State_TMT_B_MT, L2Cache_Event_L1_UPGRADE);
  s_profiler.possibleTransition(L2Cache_State_NP, L2Cache_Event_L1_TGETS);
  ...
  s_profiler.possibleTransition(L2Cache_State_NP, L2Cache_Event_L1_TGETX);
  ...
  s_profiler.possibleTransition(L2Cache_State_IS, L2Cache_Event_L1_TGETS);
  ...
  s_profiler.possibleTransition(L2Cache_State_ISS, L2Cache_Event_L1_TGETS);
  ...
  s_profiler.possibleTransition(L2Cache_State_IS, L2Cache_Event_L1_TGETX);
  s_profiler.possibleTransition(L2Cache_State_ISS, L2Cache_Event_L1_GETX);
  s_profiler.possibleTransition(L2Cache_State_ISS, L2Cache_Event_L1_TGETX);
  ...
  s_profiler.possibleTransition(L2Cache_State_IM, L2Cache_Event_L1_TGETX);
  s_profiler.possibleTransition(L2Cache_State_IM, L2Cache_Event_L1_TGETS);
  s_profiler.possibleTransition(L2Cache_State_SS, L2Cache_Event_L1_GETS);
  s_profiler.possibleTransition(L2Cache_State_SS, L2Cache_Event_L1_TGETS);
  ...
  s_profiler.possibleTransition(L2Cache_State_TMT, L2Cache_Event_L2_Replacement);
  s_profiler.possibleTransition(L2Cache_State_TMT, L2Cache_Event_L2_Replacement_clean);
  s_profiler.possibleTransition(L2Cache_State_M, L2Cache_Event_L1_GETX);
  s_profiler.possibleTransition(L2Cache_State_M, L2Cache_Event_L1_TGETX);
  ...
  s_profiler.possibleTransition(L2Cache_State_M, L2Cache_Event_L1_TGETS);
  ...
  s_profiler.possibleTransition(L2Cache_State_MT, L2Cache_Event_L1_TGETS);
  ...
  s_profiler.possibleTransition(L2Cache_State_TMT, L2Cache_Event_L1_PUTX);
  ...
  s_profiler.possibleTransition(L2Cache_State_SS_MB, L2Cache_Event_Unblock);
  s_profiler.possibleTransition(L2Cache_State_MT_MB, L2Cache_Event_Exclusive_Unblock);
  s_profiler.possibleTransition(L2Cache_State_MT_MB, L2Cache_Event_Unblock_Threat);
  s_profiler.possibleTransition(L2Cache_State_MT_IIB, L2Cache_Event_Unblock);
  s_profiler.possibleTransition(L2Cache_State_MT_IIB, L2Cache_Event_Unblock_Data);
  ...
  s_profiler.possibleTransition(L2Cache_State_I_I, L2Cache_Event_L1_TGETS);
  s_profiler.possibleTransition(L2Cache_State_I_I, L2Cache_Event_L1_TGETX);
  ...
  s_profiler.possibleTransition(L2Cache_State_S_I, L2Cache_Event_L1_TGETS);
  s_profiler.possibleTransition(L2Cache_State_S_I, L2Cache_Event_L1_TGETX);
  ...
  s_profiler.possibleTransition(L2Cache_State_MT_I, L2Cache_Event_L1_TGETS);
  s_profiler.possibleTransition(L2Cache_State_MT_I, L2Cache_Event_L1_TGETX);
  ...
  s_profiler.possibleTransition(L2Cache_State_MCT_I, L2Cache_Event_L1_TGETS);
  s_profiler.possibleTransition(L2Cache_State_MCT_I, L2Cache_Event_L1_TGETX);
  ...
  s_profiler.possibleTransition(L2Cache_State_M_I, L2Cache_Event_L1_TGETS);
  s_profiler.possibleTransition(L2Cache_State_M_I, L2Cache_Event_L1_TGETX);
  ...
  s_profiler.possibleTransition(L2Cache_State_S_I, L2Cache_Event_WB_Data);
  s_profiler.possibleTransition(L2Cache_State_S_I, L2Cache_Event_WB_Data_clean);
  s_profiler.possibleTransition(L2Cache_State_S_I, L2Cache_Event_WB_Data_All);
  s_profiler.possibleTransition(L2Cache_State_M_I, L2Cache_Event_Mem_Ack);
  s_profiler.possibleTransition(L2Cache_State_SS, L2Cache_Event_L1_TGETX);
  s_profiler.possibleTransition(L2Cache_State_MT, L2Cache_Event_L1_TGETX);
  s_profiler.possibleTransition(L2Cache_State_TMT, L2Cache_Event_L1_TGETX);
  s_profiler.possibleTransition(L2Cache_State_TMT, L2Cache_Event_L1_TGETS);
  s_profiler.possibleTransition(L2Cache_State_TMT, L2Cache_Event_L1_GETS);
  s_profiler.possibleTransition(L2Cache_State_TMT, L2Cache_Event_L1_GET_INSTR);
  s_profiler.possibleTransition(L2Cache_State_TMT, L2Cache_Event_L1_GETX);
  s_profiler.possibleTransition(L2Cache_State_TMT_B_MT, L2Cache_Event_Exclusive_Unblock);
  s_profiler.possibleTransition(L2Cache_State_TMT_B, L2Cache_Event_Unblock);
  s_profiler.possibleTransition(L2Cache_State_TMT_B, L2Cache_Event_Unblock_Data);
  s_profiler.possibleTransition(L2Cache_State_TMT_B, L2Cache_Event_Unblock_Data_Threat);
  s_profiler.possibleTransition(L2Cache_State_TMT_B, L2Cache_Event_Unblock_Threat);
}
...
void L2Cache_Controller::e_sendDataToGetSRequestors(const Address& addr)
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
    ...
    cerr << "Runtime Error at ../protocols/MESI_SCMP_bankdirectory-L2cache.sm:509, Ruby Time: " << g_eventQueue_ptr->getTime() << ": " << "assert failure" << ", PID: " << getpid() << endl;
...
;
  {
    ...
    (out_msg).m_Address = addr;
    (out_msg).m_Type = CoherenceResponseType_DATA;
    (out_msg).m_Sender = (map_Address_to_Directory(addr));
...
void L2Cache_Controller::ex_sendExclusiveDataToGetSRequestors(const Address& addr)
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
    ...
    cerr << "Runtime Error at ../protocols/MESI_SCMP_bankdirectory-L2cache.sm:523, Ruby Time: " << g_eventQueue_ptr->getTime() << ": " << "assert failure" << ", PID: " << getpid() << endl;
char c; cerr << "press return to continue." << endl; cin.get(c); abort();
...
void L2Cache_Controller::ee_sendDataToGetXRequestor(const Address& addr)
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  {
    ...
    DEBUG_SLICC(MedPrio, "../protocols/MESI_SCMP_bankdirectory-L2cache.sm:544: ", (out_msg).m_Destination);
;
    (out_msg).m_DataBlk = ((L2Cache_getL2CacheEntry(addr))).m_DataBlk;
    (out_msg).m_Dirty = ((L2Cache_getL2CacheEntry(addr))).m_Dirty;
    DEBUG_SLICC(MedPrio, "../protocols/MESI_SCMP_bankdirectory-L2cache.sm:547: ", (out_msg).m_Address);
;
    DEBUG_SLICC(MedPrio, "../protocols/MESI_SCMP_bankdirectory-L2cache.sm:548: ", (out_msg).m_Destination);
;
    DEBUG_SLICC(MedPrio, "../protocols/MESI_SCMP_bankdirectory-L2cache.sm:549: ", (out_msg).m_DataBlk);
;
    (out_msg).m_MessageSize = MessageSizeType_Response_Data;
    ((*(m_chip_ptr->m_L2Cache_responseFromL2Cache_vec[m_version]))).enqueue(out_msg, 1);
  }
...
void L2Cache_Controller::fw_sendFwdTypeToSharers(const Address& addr)
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  {
    RequestMsg* in_msg_ptr;
...
/** \brief invalidate sharers for request*/
void L2Cache_Controller::fw_sendFwdTGETXToSharers(const Address& addr)
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  {
    RequestMsg* in_msg_ptr;
...
/** \brief Write data from unblock queue to cache*/
void L2Cache_Controller::m_writeDataToCacheFromUnblockQueue(const Address& addr)
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  {
    ResponseMsg* in_msg_ptr;
...
void L2Cache_Controller::ts_sendInvAckToUpgrader(const Address& addr)
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  {
    ...
    assert(in_msg_ptr != NULL);
    {
      ...
      ((*(m_chip_ptr->m_L2Cache_responseFromL2Cache_vec[m_version]))).enqueue(out_msg, L2_REQUEST_LATENCY);
    }
  }
}
