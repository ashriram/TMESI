...
)
{
  ...
  case HASH_FUN(L2Cache_State_TMT_B, L2Cache_Event_L1_PUTX):
  case HASH_FUN(L2Cache_State_TMT_B_MT, L2Cache_Event_L1_PUTX):
  ...
  case HASH_FUN(L2Cache_State_TMT_B, L2Cache_Event_L1_PUTX_old):
  case HASH_FUN(L2Cache_State_TMT_B_MT, L2Cache_Event_L1_PUTX_old):
  {
  ...
  case HASH_FUN(L2Cache_State_TMT_B, L2Cache_Event_L2_Replacement):
  case HASH_FUN(L2Cache_State_TMT_B, L2Cache_Event_L2_Replacement_clean):
  case HASH_FUN(L2Cache_State_TMT_B_MT, L2Cache_Event_L2_Replacement):
  case HASH_FUN(L2Cache_State_TMT_B_MT, L2Cache_Event_L2_Replacement_clean):
  case HASH_FUN(L2Cache_State_SS_MB, L2Cache_Event_L1_GETS):
  case HASH_FUN(L2Cache_State_SS_MB, L2Cache_Event_L1_TGETS):
  case HASH_FUN(L2Cache_State_SS_MB, L2Cache_Event_L1_TGETX):
  ...
  case HASH_FUN(L2Cache_State_MT_MB, L2Cache_Event_L1_TGETS):
  case HASH_FUN(L2Cache_State_MT_MB, L2Cache_Event_L1_TGETX):
  ...
  case HASH_FUN(L2Cache_State_MT_IIB, L2Cache_Event_L1_TGETS):
  case HASH_FUN(L2Cache_State_MT_IIB, L2Cache_Event_L1_TGETX):
  ...
  case HASH_FUN(L2Cache_State_TMT_B, L2Cache_Event_L1_GETS):
  case HASH_FUN(L2Cache_State_TMT_B, L2Cache_Event_L1_TGETS):
  case HASH_FUN(L2Cache_State_TMT_B, L2Cache_Event_L1_TGETX):
  case HASH_FUN(L2Cache_State_TMT_B, L2Cache_Event_L1_GET_INSTR):
  case HASH_FUN(L2Cache_State_TMT_B, L2Cache_Event_L1_GETX):
  case HASH_FUN(L2Cache_State_TMT_B, L2Cache_Event_L1_UPGRADE):
  case HASH_FUN(L2Cache_State_TMT_B_MT, L2Cache_Event_L1_GETS):
  case HASH_FUN(L2Cache_State_TMT_B_MT, L2Cache_Event_L1_TGETS):
  case HASH_FUN(L2Cache_State_TMT_B_MT, L2Cache_Event_L1_TGETX):
  case HASH_FUN(L2Cache_State_TMT_B_MT, L2Cache_Event_L1_GET_INSTR):
  case HASH_FUN(L2Cache_State_TMT_B_MT, L2Cache_Event_L1_GETX):
  case HASH_FUN(L2Cache_State_TMT_B_MT, L2Cache_Event_L1_UPGRADE):
  case HASH_FUN(L2Cache_State_IS, L2Cache_Event_L1_GETS):
  case HASH_FUN(L2Cache_State_IS, L2Cache_Event_L1_TGETS):
  case HASH_FUN(L2Cache_State_IS, L2Cache_Event_L1_GET_INSTR):
  case HASH_FUN(L2Cache_State_ISS, L2Cache_Event_L1_GETS):
  case HASH_FUN(L2Cache_State_ISS, L2Cache_Event_L1_TGETS):
  case HASH_FUN(L2Cache_State_ISS, L2Cache_Event_L1_GET_INSTR):
  case HASH_FUN(L2Cache_State_IS, L2Cache_Event_L1_GETX):
  case HASH_FUN(L2Cache_State_IS, L2Cache_Event_L1_TGETX):
  case HASH_FUN(L2Cache_State_ISS, L2Cache_Event_L1_GETX):
  case HASH_FUN(L2Cache_State_ISS, L2Cache_Event_L1_TGETX):
  ...
  case HASH_FUN(L2Cache_State_IM, L2Cache_Event_L1_TGETX):
  case HASH_FUN(L2Cache_State_IM, L2Cache_Event_L1_TGETS):
  ...
  case HASH_FUN(L2Cache_State_I_I, L2Cache_Event_L1_TGETS):
  case HASH_FUN(L2Cache_State_I_I, L2Cache_Event_L1_TGETX):
  ...
  case HASH_FUN(L2Cache_State_S_I, L2Cache_Event_L1_TGETS):
  case HASH_FUN(L2Cache_State_S_I, L2Cache_Event_L1_TGETX):
  ...
  case HASH_FUN(L2Cache_State_MT_I, L2Cache_Event_L1_TGETS):
  case HASH_FUN(L2Cache_State_MT_I, L2Cache_Event_L1_TGETX):
  ...
  case HASH_FUN(L2Cache_State_MCT_I, L2Cache_Event_L1_TGETS):
  case HASH_FUN(L2Cache_State_MCT_I, L2Cache_Event_L1_TGETX):
  ...
  case HASH_FUN(L2Cache_State_M_I, L2Cache_Event_L1_TGETS):
  case HASH_FUN(L2Cache_State_M_I, L2Cache_Event_L1_TGETX):
  case HASH_FUN(L2Cache_State_MT_MB, L2Cache_Event_L1_PUTX):
  {
    zz_recycleL1RequestQueue(addr);
    return TransitionResult_Valid;
  }
  case HASH_FUN(L2Cache_State_NP, L2Cache_Event_L1_TGETS):
  ...
  case HASH_FUN(L2Cache_State_NP, L2Cache_Event_L1_TGETX):
  {
    next_state = L2Cache_State_IM;
    if (!(*(m_chip_ptr->m_L2Cache_DirRequestFromL2Cache_vec[m_version])).areNSlotsAvailable(1)) {
      return TransitionResult_ResourceStall;
  ...
  case HASH_FUN(L2Cache_State_SS, L2Cache_Event_L1_TGETS):
  ...
  case HASH_FUN(L2Cache_State_TMT, L2Cache_Event_L2_Replacement):
  case HASH_FUN(L2Cache_State_TMT, L2Cache_Event_L2_Replacement_clean):
  {
  ...
  case HASH_FUN(L2Cache_State_M, L2Cache_Event_L1_TGETS):
  {
    next_state = L2Cache_State_MT_MB;
    if (!(*(m_chip_ptr->m_L2Cache_responseFromL2Cache_vec[m_version])).areNSlotsAvailable(1)) {
      return TransitionResult_ResourceStall;
  ...
  case HASH_FUN(L2Cache_State_M, L2Cache_Event_L1_TGETX):
  {
    next_state = L2Cache_State_MT_MB;
    if (!(*(m_chip_ptr->m_L2Cache_responseFromL2Cache_vec[m_version])).areNSlotsAvailable(1)) {
      return TransitionResult_ResourceStall;
  ...
  case HASH_FUN(L2Cache_State_MT, L2Cache_Event_L1_TGETS):
  {
  ...
  case HASH_FUN(L2Cache_State_TMT, L2Cache_Event_L1_PUTX):
  {
  ...
  case HASH_FUN(L2Cache_State_SS_MB, L2Cache_Event_Unblock):
  {
  ...
  case HASH_FUN(L2Cache_State_TMT_B_MT, L2Cache_Event_Exclusive_Unblock):
  {
    next_state = L2Cache_State_MT;
  ...
  case HASH_FUN(L2Cache_State_MT_MB, L2Cache_Event_Unblock_Threat):
  case HASH_FUN(L2Cache_State_TMT_B, L2Cache_Event_Unblock_Threat):
  {
    next_state = L2Cache_State_TMT;
    nnu_addSharerFromUnblock(addr);
    k_popUnblockQueue(addr);
    return TransitionResult_Valid;
  }
  case HASH_FUN(L2Cache_State_MT_IIB, L2Cache_Event_Unblock):
  case HASH_FUN(L2Cache_State_TMT_B, L2Cache_Event_Unblock):
  {
    next_state = L2Cache_State_SS;
    nnu_addSharerFromUnblock(addr);
    k_popUnblockQueue(addr);
  ...
  case HASH_FUN(L2Cache_State_MT_IIB, L2Cache_Event_Unblock_Data):
  {
    next_state = L2Cache_State_SS;
    nnu_addSharerFromUnblock(addr);
    m_writeDataToCacheFromUnblockQueue(addr);
    k_popUnblockQueue(addr);
    return TransitionResult_Valid;
  }
  ...
  case HASH_FUN(L2Cache_State_S_I, L2Cache_Event_WB_Data_All):
  {
    next_state = L2Cache_State_M_I;
    if (!(*(m_chip_ptr->m_L2Cache_responseFromL2Cache_vec[m_version])).areNSlotsAvailable(1)) {
      return TransitionResult_ResourceStall;
  ...
  case HASH_FUN(L2Cache_State_S_I, L2Cache_Event_WB_Data):
  {
    qq_writeDataToTBE(addr);
    o_popIncomingResponseQueue(addr);
    return TransitionResult_Valid;
  }
  case HASH_FUN(L2Cache_State_S_I, L2Cache_Event_WB_Data_clean):
  {
    o_popIncomingResponseQueue(addr);
    return TransitionResult_Valid;
  }
  case HASH_FUN(L2Cache_State_SS, L2Cache_Event_L1_TGETX):
  case HASH_FUN(L2Cache_State_MT, L2Cache_Event_L1_TGETX):
  case HASH_FUN(L2Cache_State_TMT, L2Cache_Event_L1_TGETX):
  {
    next_state = L2Cache_State_TMT_B;
    if (!(*(m_chip_ptr->m_L2Cache_L1RequestFromL2Cache_vec[m_version])).areNSlotsAvailable(1)) {
      return TransitionResult_ResourceStall;
    }
    if (!(*(m_chip_ptr->m_L2Cache_responseFromL2Cache_vec[m_version])).areNSlotsAvailable(1)) {
  ...
  case HASH_FUN(L2Cache_State_TMT, L2Cache_Event_L1_TGETS):
  case HASH_FUN(L2Cache_State_TMT, L2Cache_Event_L1_GETS):
  case HASH_FUN(L2Cache_State_TMT, L2Cache_Event_L1_GET_INSTR):
  {
    next_state = L2Cache_State_TMT_B;
    if (!(*(m_chip_ptr->m_L2Cache_L1RequestFromL2Cache_vec[m_version])).areNSlotsAvailable(1)) {
      return TransitionResult_ResourceStall;
  ...
  case HASH_FUN(L2Cache_State_TMT, L2Cache_Event_L1_GETX):
  {
    next_state = L2Cache_State_TMT_B_MT;
    if (!(*(m_chip_ptr->m_L2Cache_L1RequestFromL2Cache_vec[m_version])).areNSlotsAvailable(1)) {
      return TransitionResult_ResourceStall;
    }
    if (!(*(m_chip_ptr->m_L2Cache_responseFromL2Cache_vec[m_version])).areNSlotsAvailable(1)) {
  ...
  case HASH_FUN(L2Cache_State_TMT_B, L2Cache_Event_Unblock_Data):
  {
    next_state = L2Cache_State_SS;
    nnu_addSharerFromUnblock(addr);
    m_writeDataToCacheFromUnblockQueue(addr);
  ...
  case HASH_FUN(L2Cache_State_TMT_B, L2Cache_Event_Unblock_Data_Threat):
  {
    next_state = L2Cache_State_TMT;
    m_writeDataToCache(addr);
    nnu_addSharerFromUnblock(addr);
