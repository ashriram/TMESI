...
enum L2Cache_State {
  ...
  L2Cache_State_TMT,  /**< L2 cache entry possibly modified; possible multiple sharers when Transactional. */
  ...
  L2Cache_State_TMT_B,  /**< Blocked for L1 GETS,L1_TGETS,L1_TGETX, from MT, got unblock threat, waiting for data */
  L2Cache_State_TMT_B_MT,  /**< TMT to MT state; TMT and Received L1 GETX */
  L2Cache_State_NUM
};
