...
string L2Cache_State_to_string(const L2Cache_State& obj)
{
  ...
  case L2Cache_State_MT_IIB:
    return "MT_IIB";
  case L2Cache_State_TMT_B:
    return "TMT_B";
  case L2Cache_State_TMT_B_MT:
    return "TMT_B_MT";
  default:
...
L2Cache_State string_to_L2Cache_State(const string& str)
{
  if (false) {
    ...
    return L2Cache_State_TMT_B;
  } else if (str == "TMT_B_MT") {
    return L2Cache_State_TMT_B_MT;
  } else {
    WARN_EXPR(str);
