...
public:
  ...
  : AbstractCacheEntry()
  {
    ...
    m_Abort = false; // default value of bool
    m_Dirty = false; // default for this field 
  }
  ~L1Cache_Entry() { };
  L1Cache_Entry(const L1Cache_State& local_CacheState, const DataBlock& local_DataBlk, const bool& local_Trans, const bool& local_Abort, const bool& local_Dirty)
  : AbstractCacheEntry()
  {
...
/** \brief Const accessor method for Abort field.
  * \return Abort field
  */
...
/** \brief Non-const accessor method for Abort field.
  * \return Abort field
  */
...
/** \brief Mutator method for Abort field */
  void setAbort(const bool& local_Abort) { m_Abort = local_Abort; }
...
//private:
  ...
  bool m_Abort; /**< If aborted after TM*/
