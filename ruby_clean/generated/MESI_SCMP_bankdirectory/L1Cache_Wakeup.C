      ...
      if ((((*(m_chip_ptr->m_L1Cache_responseToL1Cache_vec[m_version]))).isReady())) {
        {
          ...
          assert(in_msg_ptr != NULL);
            ...
            cerr << "Runtime Error at ../protocols/MESI_SCMP_bankdirectory-L1cache.sm:311, Ruby Time: " << g_eventQueue_ptr->getTime() << ": " << "assert failure" << ", PID: " << getpid() << endl;
...
;
            ...
            if ((((*in_msg_ptr)).m_Type == CoherenceResponseType_DATA)) {
              if (((((((*(m_chip_ptr->m_L1Cache_L1_TBEs_vec[m_version]))).lookup(((*in_msg_ptr)).m_Address))).m_pendingAcks - ((*in_msg_ptr)).m_AckCount) == (0))) {
                if ((((((((*(m_chip_ptr->m_L1Cache_L1_TBEs_vec[m_version]))).lookup(((*in_msg_ptr)).m_Address))).m_Threat == (true)) && (((((*(m_chip_ptr->m_L1Cache_L1_TBEs_vec[m_version]))).lookup(((*in_msg_ptr)).m_Address))).m_TBEState == L1Cache_State_IS)) && ((((((*(m_chip_ptr->m_L1Cache_L1_TBEs_vec[m_version]))).lookup(((*in_msg_ptr)).m_Address))).m_Threat == (true)) || (((*in_msg_ptr)).m_Threat == (true))))) {
                                    {
                    Address addr = ((*in_msg_ptr)).m_Address;
                    TransitionResult result = doTransition(L1Cache_Event_Data_all_Acks_Threat, L1Cache_getState(addr), addr);
                    if (result == TransitionResult_Valid) {
                      counter++;
                      continue; // Check the first port again
                    }
...
;
                                        ...
                                        {
                      Address addr = ((*in_msg_ptr)).m_Address;
                      TransitionResult result = doTransition(L1Cache_Event_Ack_all_Threat, L1Cache_getState(addr), addr);
                      if (result == TransitionResult_Valid) {
                        counter++;
                        continue; // Check the first port again
                      }
...
;
                                    ...
                                    cerr << "Runtime Error at ../protocols/MESI_SCMP_bankdirectory-L1cache.sm:338, Ruby Time: " << g_eventQueue_ptr->getTime() << ": " << ("Invalid L1 response type") << ", PID: " << getpid() << endl;
char c; cerr << "press return to continue." << endl; cin.get(c); abort();
      ...
      if ((((*(m_chip_ptr->m_L1Cache_requestToL1Cache_vec[m_version]))).isReady())) {
        {
          ...
          assert(in_msg_ptr != NULL);
                    if (ASSERT_FLAG && !(((((*in_msg_ptr)).m_Destination).isElement(m_machineID)))) {
            cerr << "Runtime Error at ../protocols/MESI_SCMP_bankdirectory-L1cache.sm:349, Ruby Time: " << g_eventQueue_ptr->getTime() << ": " << "assert failure" << ", PID: " << getpid() << endl;
char c; cerr << "press return to continue." << endl; cin.get(c); abort();
...
;
                  ...
                  if ((((*in_msg_ptr)).m_Type == CoherenceRequestType_TGETX)) {
                                        {
                      Address addr = ((*in_msg_ptr)).m_Address;
                      TransitionResult result = doTransition(L1Cache_Event_Fwd_TGETX, L1Cache_getState(addr), addr);
                      if (result == TransitionResult_Valid) {
                        counter++;
                        continue; // Check the first port again
                      }
...
;
                    ...
                    if ((((*in_msg_ptr)).m_Type == CoherenceRequestType_TGETS)) {
                                            {
                        Address addr = ((*in_msg_ptr)).m_Address;
                        TransitionResult result = doTransition(L1Cache_Event_Fwd_TGETS, L1Cache_getState(addr), addr);
                        if (result == TransitionResult_Valid) {
                          counter++;
                          continue; // Check the first port again
                        }
...
;
                                            ...
                                            cerr << "Runtime Error at ../protocols/MESI_SCMP_bankdirectory-L1cache.sm:365, Ruby Time: " << g_eventQueue_ptr->getTime() << ": " << ("Invalid forwarded request type") << ", PID: " << getpid() << endl;
char c; cerr << "press return to continue." << endl; cin.get(c); abort();
