...
public:
  ...
  : NetworkMessage()
  {
    ...
    m_Threat = false; // default value of bool
  ...
  ~ResponseMsg() { };
  ResponseMsg(const Address& local_Address, const CoherenceResponseType& local_Type, const bool& local_Threat, const bool& local_Read, const MachineID& local_Sender, const NetDest& local_Destination, const DataBlock& local_DataBlk, const bool& local_Dirty, const int& local_AckCount, const MessageSizeType& local_MessageSize)
  : NetworkMessage()
  {
...
//private:
  ...
  bool m_Threat; /**< Say if line is threatened*/
  bool m_Read; /**< Type of conflict read or write conflict*/
