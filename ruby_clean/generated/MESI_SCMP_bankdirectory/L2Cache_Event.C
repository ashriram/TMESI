...
string L2Cache_Event_to_string(const L2Cache_Event& obj)
{
  ...
  case L2Cache_Event_L1_GETS:
    return "L1_GETS";
  case L2Cache_Event_L1_TGETS:
    return "L1_TGETS";
  case L2Cache_Event_L1_GETX:
    return "L1_GETX";
  case L2Cache_Event_L1_TGETX:
    return "L1_TGETX";
  ...
  case L2Cache_Event_WB_Data_All:
    return "WB_Data_All";
  ...
  case L2Cache_Event_Unblock_Data:
    return "Unblock_Data";
  case L2Cache_Event_Unblock_Threat:
    return "Unblock_Threat";
  case L2Cache_Event_Unblock_Data_Threat:
...
L2Cache_Event string_to_L2Cache_Event(const string& str)
{
  if (false) {
  ...
  } else if (str == "L1_TGETS") {
    return L2Cache_Event_L1_TGETS;
  } else if (str == "L1_GETX") {
    return L2Cache_Event_L1_GETX;
  } else if (str == "L1_TGETX") {
    return L2Cache_Event_L1_TGETX;
  ...
  } else if (str == "WB_Data_All") {
    return L2Cache_Event_WB_Data_All;
  } else if (str == "Ack") {
    ...
    return L2Cache_Event_Unblock_Data;
  } else if (str == "Unblock_Threat") {
    return L2Cache_Event_Unblock_Threat;
  } else if (str == "Unblock_Data_Threat") {
    return L2Cache_Event_Unblock_Data_Threat;
  } else {
    WARN_EXPR(str);
