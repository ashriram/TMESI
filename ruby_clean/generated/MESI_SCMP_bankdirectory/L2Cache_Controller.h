...
/** \brief invalidate sharers for request*/
  void fw_sendFwdTypeToSharers(const Address& addr);
/** \brief invalidate sharers for request*/
  void fw_sendFwdTGETXToSharers(const Address& addr);
...
/** \brief Write data from unblock queue to cache*/
  void m_writeDataToCacheFromUnblockQueue(const Address& addr);
/** \brief Write data from response queue to cache*/
