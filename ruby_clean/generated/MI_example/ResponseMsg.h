...
public:
  ...
  ~ResponseMsg() { };
  ResponseMsg(const Address& local_Address, const CoherenceResponseType& local_Type, const MachineID& local_Sender, const NetDest& local_Destination, const DataBlock& local_DataBlk, const bool& local_Dirty, const int& local_Acks, const MessageSizeType& local_MessageSize)
  : NetworkMessage()
  {
...
//private:
  ...
  MachineID m_Sender; /**< Node who sent the data*/
