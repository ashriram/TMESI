...
enum L2Cache_State {
  ...
  L2Cache_State_SS_SSB,  /**< Blocked for L1_GETS from SS */
  L2Cache_State_MT_MB,  /**< Blocked for L1_GETX from MT */
  L2Cache_State_M_MB,  /**< Blocked for L1_GETX from M */
  L2Cache_State_ISS_MB,  /**< Blocked for L1_GETS or L1_GETX from NP, received Mem Data */
  L2Cache_State_IS_SSB,  /**< Blocked for L1_GET_INSTR from NP, received Mem Data */
  L2Cache_State_M_SSB,  /**< Blocked for L1_GET_INSTR from M */
  ...
  L2Cache_State_PB_MT,  /**< Going to MT, got data and unblock, waiting for PUT */
  L2Cache_State_PB_SS,  /**< Going to SS, got unblock, waiting for PUT */
  L2Cache_State_PB_MT_IB,  /**< Blocked from MT, got unblock, waiting for data and PUT */
  L2Cache_State_NUM
};
