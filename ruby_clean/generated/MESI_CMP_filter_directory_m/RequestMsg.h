...
public:
  ...
  : NetworkMessage()
  {
    ...
    m_ConflictType = false; // default for this field 
    m_Prefetch = PrefetchBit_No; // default value of PrefetchBit
    // m_Timestamp has no default
  }
  ~RequestMsg() { };
  RequestMsg(const Address& local_Address, const Address& local_PhysicalAddress, const CoherenceRequestType& local_Type, const AccessModeType& local_AccessMode, const MachineID& local_Requestor, const NetDest& local_Destination, const MessageSizeType& local_MessageSize, const DataBlock& local_DataBlk, const bool& local_Dirty, const bool& local_ConflictType, const PrefetchBit& local_Prefetch, const uint64& local_Timestamp)
  : NetworkMessage()
  {
