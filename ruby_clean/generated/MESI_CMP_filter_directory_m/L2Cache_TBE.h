...
public:
  ...
  ~L2Cache_TBE() { };
  L2Cache_TBE(const Address& local_Address, const Address& local_PhysicalAddress, const L2Cache_State& local_TBEState, const DataBlock& local_DataBlk, const bool& local_Dirty, const NetDest& local_L1_GetS_IDs, const MachineID& local_L1_GetX_ID, const bool& local_isPrefetch, const int& local_pendingAcks, const bool& local_nack)
  {
