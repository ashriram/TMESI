...
// Directory: MESI_CMP_filter_directory protocol
      ...
      if ((((*(m_chip_ptr->m_Directory_requestToDir_vec[m_version]))).isReady())) {
        {
          ...
          assert(in_msg_ptr != NULL);
            ...
            cerr << "Runtime Error at ../protocols/MESI_CMP_filter_directory_m-mem.sm:129, Ruby Time: " << g_eventQueue_ptr->getTime() << ": " << "assert failure" << ", PID: " << getpid() << endl;
char c; cerr << "press return to continue." << endl; cin.get(c); abort();

          }
;
          if ((Directory_isGETRequest(((*in_msg_ptr)).m_Type))) {
                        {
...
;
            ...
            DEBUG_SLICC(MedPrio, "../protocols/MESI_CMP_filter_directory_m-mem.sm:133: ", (*in_msg_ptr));
;
                        cerr << "Runtime Error at ../protocols/MESI_CMP_filter_directory_m-mem.sm:134, Ruby Time: " << g_eventQueue_ptr->getTime() << ": " << ("Invalid message") << ", PID: " << getpid() << endl;
char c; cerr << "press return to continue." << endl; cin.get(c); abort();
      ...
      if ((((*(m_chip_ptr->m_Directory_responseToDir_vec[m_version]))).isReady())) {
        {
          ...
          assert(in_msg_ptr != NULL);
                    if (ASSERT_FLAG && !(((((*in_msg_ptr)).m_Destination).isElement(m_machineID)))) {
            cerr << "Runtime Error at ../protocols/MESI_CMP_filter_directory_m-mem.sm:143, Ruby Time: " << g_eventQueue_ptr->getTime() << ": " << "assert failure" << ", PID: " << getpid() << endl;
char c; cerr << "press return to continue." << endl; cin.get(c); abort();
...
;
            ...
            DEBUG_SLICC(MedPrio, "../protocols/MESI_CMP_filter_directory_m-mem.sm:147: ", ((*in_msg_ptr)).m_Type);
;
                        cerr << "Runtime Error at ../protocols/MESI_CMP_filter_directory_m-mem.sm:148, Ruby Time: " << g_eventQueue_ptr->getTime() << ": " << ("Invalid message") << ", PID: " << getpid() << endl;
char c; cerr << "press return to continue." << endl; cin.get(c); abort();
...
;
              ...
              DEBUG_SLICC(MedPrio, "../protocols/MESI_CMP_filter_directory_m-mem.sm:163: ", ((*in_msg_ptr)).m_Type);
;
                            cerr << "Runtime Error at ../protocols/MESI_CMP_filter_directory_m-mem.sm:164, Ruby Time: " << g_eventQueue_ptr->getTime() << ": " << ("Invalid message") << ", PID: " << getpid() << endl;
char c; cerr << "press return to continue." << endl; cin.get(c); abort();
