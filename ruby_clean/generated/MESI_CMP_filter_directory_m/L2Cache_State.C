...
string L2Cache_State_to_string(const L2Cache_State& obj)
{
  ...
  case L2Cache_State_SS_MB:
    return "SS_MB";
  case L2Cache_State_SS_SSB:
    return "SS_SSB";
  case L2Cache_State_MT_MB:
    return "MT_MB";
  case L2Cache_State_M_MB:
    return "M_MB";
  case L2Cache_State_ISS_MB:
    return "ISS_MB";
  case L2Cache_State_IS_SSB:
    return "IS_SSB";
  case L2Cache_State_M_SSB:
    return "M_SSB";
  ...
  case L2Cache_State_MT_SB:
    return "MT_SB";
  case L2Cache_State_PB_MT:
    return "PB_MT";
  case L2Cache_State_PB_SS:
    return "PB_SS";
  case L2Cache_State_PB_MT_IB:
    return "PB_MT_IB";
  default:
...
L2Cache_State string_to_L2Cache_State(const string& str)
{
  if (false) {
    ...
    return L2Cache_State_SS_SSB;
  } else if (str == "MT_MB") {
    return L2Cache_State_MT_MB;
  } else if (str == "M_MB") {
    return L2Cache_State_M_MB;
  } else if (str == "ISS_MB") {
    return L2Cache_State_ISS_MB;
  } else if (str == "IS_SSB") {
    return L2Cache_State_IS_SSB;
  } else if (str == "M_SSB") {
    return L2Cache_State_M_SSB;
  } else if (str == "MT_IIB") {
    ...
    return L2Cache_State_PB_MT;
  } else if (str == "PB_SS") {
    return L2Cache_State_PB_SS;
  } else if (str == "PB_MT_IB") {
    return L2Cache_State_PB_MT_IB;
  } else {
    WARN_EXPR(str);
